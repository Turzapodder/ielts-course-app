...
const CourseFeatures = dynamic(() => import('./sections/CourseStructure'), {
  loading: () => <LoadingSkeleton variant="custom" height="h-64" className="rounded-lg" />
});

const TestimonialSlider = dynamic(() => import('./ui/TestimonialSlider'), {
  loading: () => <LoadingSkeleton variant="custom" height="h-96" className="rounded-lg" />
});

const LearningOutcomes = dynamic(() => import('./sections/CourseOutcome'), {
  loading: () => <LoadingSkeleton variant="custom" height="h-64" className="rounded-lg" />
});

const CourseExclusiveFeatures = dynamic(() => import('./sections/CourseExclusive'), {
  loading: () => <LoadingSkeleton variant="custom" height="h-64" className="rounded-lg" />
});

const UniversalAccordion = dynamic(() => import('./ui/Accordion'), {
  loading: () => <LoadingSkeleton variant="custom" height="h-48" className="rounded-lg" />
});

const GroupJoinEngagement = dynamic(() => import('./sections/GroupJoinEngagementData'), {
  loading: () => <LoadingSkeleton variant="custom" height="h-32" className="rounded-lg" />
});

// Dynamic import for CTA section (interactive)
const CTASection = dynamic(() => import('./ui/CTASection'), {
